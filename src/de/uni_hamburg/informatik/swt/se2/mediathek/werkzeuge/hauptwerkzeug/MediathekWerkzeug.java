...
public class MediathekWerkzeug
{
            ...
            KundenstammService kundenstamm, VerleihService verleihService, VormerkService vormerkService)
    {
        ...
        _rueckgabeWerkzeug = new RueckgabeWerkzeug(_verleihService,_vormerkService);
        _vormerkWerkzeug = new VormerkWerkzeug(_medienbestand, _kundenstamm, _verleihService, _vormerkService);
        // Erzeuge UI für dieses Werkzeug
        _mediathekUI = new MediathekUI(
        		_ausleihWerkzeug.getUIPanel(),
                _rueckgabeWerkzeug.getUIPanel(),
                _vormerkWerkzeug.getUIPanel());
